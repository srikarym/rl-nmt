...
rollouts = RolloutStorage(args.num_steps, 2, args.num_processes,
...
for epoch in range(args.n_epochs + 1):
	...
	for ite in range(sen_per_epoch):
		...
		writer.add_scalar('Running rank of predicted actions', np.mean(ranks_iter) / total_steps,
	...
	total_loss = args.value_loss_coef * (value_loss_epoch / sen_per_epoch) + (action_loss_epoch / sen_per_epoch) - (
				dist_entropy_epoch / sen_per_epoch) * args.entropy_coef
